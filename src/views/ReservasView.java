...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtValor.setBounds(82, 328, 71, 33);
		txtValor.setEditable(false);
		txtValor.setFont(new Font("Dialog", Font.BOLD, 17));
		...
		lblTitulo.setBounds(94, 60, 240, 42);
		...
		ImagenFondo.setBounds(-132, -9, 620, 585);
		panel_1.add(ImagenFondo);
		ImagenFondo.setBackground(Color.WHITE);
		ImagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/imagenes/img_reservas.png")));
