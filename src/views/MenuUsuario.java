...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnRegistro.setBounds(0, 304, 257, 56);
		btnRegistro.setBackground(new Color(12, 138, 199));
		...
		btnBuscar.setBounds(0, 383, 257, 56);
		btnBuscar.setBackground(new Color(12, 138, 199));
		...
		separator.setBounds(26, 233, 201, 2);
		panelMenu.add(separator);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/banner_cliente.png")));
		lblNewLabel.setBounds(0, 35, 257, 576);
	    ...
	    JPanel btnClosed = new JPanel();
	    btnClosed.addMouseListener(new MouseAdapter() {
	    	
	    	@Override
			public void mouseEntered(MouseEvent e) {
	    		btnClosed.setBackground(new Color(118, 187, 223));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnClosed.setBackground(new Color(0, 255, 255));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
	    ...
	    btnClosed.setBackground(new Color(0, 255, 255));
	    btnClosed.setBounds(769, 552, 154, 46);
	    btnClosed.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
	    contentPane.add(btnClosed);
	    btnClosed.setLayout(null);
	    
	    
	    
	    JLabel Label_Closed = DefaultComponentFactory.getInstance().createLabel("CLOSED");
	    Label_Closed.setBounds(20, 3, 106, 41);
	    Label_Closed.setForeground(new Color(255, 0, 0));
	    Label_Closed.setLabelFor(this);
	    Label_Closed.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/cerrar-sesion 32-px.png")));
	    Label_Closed.setFont(new Font("Tahoma", Font.BOLD, 16));
	    btnClosed.add(Label_Closed);
