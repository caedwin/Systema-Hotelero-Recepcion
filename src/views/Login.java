...
public class Login extends JFrame {
	...
	public Login() {
		...
		panel_1.setBounds(372, 0, 416, 527);
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		labelExit = new JLabel("X");
		labelExit.setBounds(363, 0, 53, 36);
		panel_1.add(labelExit);
		labelExit.setForeground(SystemColor.text);
		labelExit.setFont(new Font("Roboto", Font.PLAIN, 18));
		labelExit.setHorizontalAlignment(SwingConstants.CENTER);		
		
		JPanel btnexit = new JPanel();
		btnexit.setBounds(363, 0, 53, 36);
		panel_1.add(btnexit);
		...
		imgHotel.setBounds(-38, 0, 454, 527);
		panel_1.add(imgHotel);
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/candado.png")));
		...
		txtUsuario.setBounds(36, 256, 324, 32);
		panel.add(txtUsuario);
		txtUsuario.setColumns(10);
		
		JSeparator separator = new JSeparator();
		separator.setBackground(new Color(0, 120, 215));
		separator.setBounds(36, 300, 324, 2);
		panel.add(separator);
		
		JLabel labelTitulo = new JLabel("INICIAR SESIÓN");
		labelTitulo.setForeground(SystemColor.textHighlight);
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(36, 149, 202, 26);
		panel.add(labelTitulo);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBackground(SystemColor.textHighlight);
		separator_1.setBounds(36, 393, 324, 2);
		...
		txtContrasena.setBounds(36, 349, 324, 32);
		...
		LabelUsuario.setBounds(36, 218, 107, 26);
		...
		lblContrasea.setBounds(36, 314, 140, 26);
		...
		btnLogin.setBackground(SystemColor.textHighlight);
		btnLogin.setBounds(36, 431, 122, 44);
		panel.add(btnLogin);
		...
		lblNewLabel_1.setBounds(36, 65, 48, 59);
