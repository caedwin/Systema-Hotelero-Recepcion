...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setBounds(0, 0, 700, 501);
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/hotel_5_estrellas.png")));
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Edwin Camacho copyright© 2022");
		lblCopyR.setBounds(256, 11, 368, 19);
