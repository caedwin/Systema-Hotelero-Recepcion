...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		lblNewLabel_4.setBounds(592, 55, 253, 42);
		...
		imagenFondo.setBounds(0, 38, 489, 613);
		panel.add(imagenFondo);
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/img_huesped.png")));
